...
- (void)setBadgeLabelBackgroundColor:(UIColor *)badgeLabelBackgroundColor{
    self->_badgeLabelBackgroundColor = badgeLabelBackgroundColor;
    [self setupBadgeStyle];
}
...
//    self.badgeTextColor = [UIColor whiteColor];
    ...
    if (self.hideWhenZero) {
        badgeLabel.hidden = [string isEqualToString:@"0"] || [string isEqualToString:@"(null)"] ? YES : NO;
    }
}
...
- (void) setupBadgeStyle
{
    ...
    [badgeLabel setBackgroundColor:self.badgeLabelBackgroundColor];
