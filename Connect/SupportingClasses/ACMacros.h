...
// View origin(x,y), size(width,height)
...
// default height of the system control
...
/* ****************************************************************************************************************** */
#pragma mark - Function Method (Macro method)
...
// iPhone6
#define isiPhone6Plus           ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? \
...
/** NSLocalizedString bundle “Localizable.strings” */
#define LocalString(x, ...)     NSLocalizedString(x, nil)
/** NSLocalizedStringFromTable bundle “xxx.strings” */
#define AppLocalString(x, ...)  NSLocalizedStringFromTable(x, @"someName", nil)

// RGB Color Conversion（16Bit->10Bit）
...
/* ****************************************************************************************************************** */
#pragma mark - Log Method (Macro LOG)
...
/** The number of milliseconds a day */
